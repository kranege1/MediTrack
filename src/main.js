...
function render() {
  ...
  appDiv.innerHTML = `
    <div class="header">
      <div>
        <div class="text-h1">MedicaTrack <span style="font-size: 14px; color: var(--accent-color); vertical-align: top;">v4.79.0</span></div>
    ...
    <div class="glass-panel">
      ...
      <div style="margin-top:32px; padding-top:20px; border-top:1px solid var(--glass-border); text-align:center;">
        ...
        <p style="font-size:10px; opacity:0.5; margin-top:8px;">
          Current: 4.79.0 \u2022 Use if UI seems outdated.
        </p>
      </div>
    </div>
  `;
